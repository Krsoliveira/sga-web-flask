...
LISTA_ATIVIDADES = [
    "Coleta de amostras para classificação",
    "Preenchimento dos registros de portaria",
    "Variação nas taras de caminhões",
    "Modificação no tíquete de pesagem",
    "Controle de utilização dos formulários da moega",
